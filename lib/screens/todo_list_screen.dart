...
class _TodoListScreenState extends State<TodoListScreen> {
  ...
  Widget build(BuildContext context) {
    // print('TOken in the screen $token');
    return FutureBuilder(
        future: getTokenFromDatabase(),
        builder: (context, snapsot) {
          return snapsot.connectionState == ConnectionState.waiting
              ? Center()
              : snapsot.hasData
                  ? Scaffold(
                      drawer: MainDrawer(
